...
class Remind extends Component {
    constructor(props) {
        ...
        this.state = {
            rule: [
                '如欲訂購，請於臉書粉絲專頁(搜尋冰帝咖啡)留下您的訂購資訊；亦可於@Line 線上下訂(@C.M BINGDI)，或來電洽詢，專線 02-55994585#100、#101。',
                '若未開封，經典冰滴可冷藏 7 天，其他特調飲品可冷藏 3 天(瓶身都有標註最佳賞味期限)，特調飲品開封後，建議 2 小時內飲畢。',
                ...
                '醫療相關專家建議，每日咖啡攝取量以不超過 400mg 尤佳，飲用時請注意身體狀況，以上資料參考 JAMA Internal Medicine 美國醫學會內科學期刊。',
