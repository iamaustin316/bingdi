...
class Remind extends Component {
    constructor(props) {
        ...
        this.state = {
            rule: [
                '如欲訂購，請於臉書粉絲專頁(搜尋冰帝咖啡)留下您的訂購資訊；亦可於@Line 線上下訂(@C.M BINGDI)，或來電洽詢，專線02-8281-1321。',
                ...
                '若對於產品有任何問題，歡迎撥打客服專線：02-8281-1321。若無人接聽可於 Line@ 線上客服洽詢，或由粉絲專頁私訊，冰帝將於收到訊息後盡速回覆。'
            ]
        }
    }
    render() { 
